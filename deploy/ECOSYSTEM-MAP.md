...
| | **dsh-agora-plugin**（npm `dsh-agora-plugin@0.6.2`） | **dsh-matrix-connector**（npm `dsh-matrix-connector@0.1.4`；源码仓 GitHub develop） |
|---|---|---|
...
- connector: npm `dsh-matrix-connector@0.1.4`（2026-08-30 与仓库最新代码比对零差异）+ GitHub `develop`（装机文档）
