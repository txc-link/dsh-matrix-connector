...
| | **dsh-agora-plugin**（npm `dsh-agora-plugin@0.6.2`） | **dsh-matrix-connector**（npm `dsh-matrix-connector@0.1.5`；源码仓 GitHub develop） |
|---|---|---|
...
- connector: npm `dsh-matrix-connector@0.1.5`（2026-08-30，Node 端 Rust Crypto 使用内存 store）+ GitHub `develop`（装机文档）
